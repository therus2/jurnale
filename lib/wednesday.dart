...
class _DayScreenState extends State<DayScreen> {
  bool loading = true;
  List<PairItem> pairs = [];
  final String filename = 'assets/data/wednesday.json';
  ...
  void openPair(PairItem p) async {
    await Navigator.of(context).push(MaterialPageRoute(builder: (_)=>PairDetailPage(pair:p, dayFile:'wednesday.json')));
    await loadDay();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Среда')),
